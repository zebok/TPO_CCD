# ============================================================================
# XGBOOST - PREDICCIÓN DE TUMOR_STAGE (BINARIO: Early vs Advanced)
# ============================================================================
# Objetivo: Predecir si el tumor es Early (Stage I-II) o Advanced (Stage III-IV)
#           usando solo información accesible (genes, imagen, demográficos)
# ============================================================================
...
output_path <- file.path(project_root, "output", "xgboost_tumor_stage_binary_confusion.png")
ggsave(output_path, plot = plot_confusion, width = 10, height = 8, dpi = 300)
print(paste("Gráfico guardado en:", output_path))

# --- 9. GUARDAR MODELO ---
model_path <- file.path(project_root, "output", "xgboost_tumor_stage_binary_model.rds")
